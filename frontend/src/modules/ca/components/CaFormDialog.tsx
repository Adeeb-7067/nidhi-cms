...
export function CaFormDialog({
  ...
  submitLabel?: string;
  /** View mode — fields disabled, Close only. */
  readOnly?: boolean;
}) {
  return (
...
export function CaTextInput(props: React.ComponentProps<typeof Input>) {
  return <Input className="h-8 text-xs" {...props} />;
}

export function CaTextArea(props: React.ComponentProps<typeof Textarea>) {
