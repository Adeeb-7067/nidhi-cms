...
export const CMS_MODULE_LABELS: Record<string, string> = {
  ...
  legal: "Legal",
  marketing_dashboard: "Digital dashboard",
  marketing_clients: "Digital projects",
  marketing_tasks: "Digital tasks",
  marketing_media: "Digital media",
  marketing_calendar: "Content calendar",
  marketing_content: "Content / graphics / video",
