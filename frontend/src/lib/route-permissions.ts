...
const ROUTE_PREFIX_PERMISSIONS: Array<[string, CmsModule]> = [
  ...
  ["/dev/payments", "finance_freelancers"],
  ...
  ["/legal/", "legal"],
  ["/marketing/projects", "marketing_clients"],
  ["/marketing/tasks", "marketing_tasks"],
  ["/marketing/media", "marketing_media"],
  ["/marketing/calendar", "marketing_calendar"],
  ["/marketing/graphics", "marketing_content"],
  ["/marketing/videos", "marketing_content"],
  ["/marketing/content", "marketing_content"],
  ["/marketing/approvals", "marketing_approvals"],
  ["/marketing/meta-ads", "marketing_ads"],
  ["/marketing/google-ads", "marketing_ads"],
  ...
  ["/freelancers/dashboard", "finance_freelancers"],
  ["/freelancers/directory", "finance_freelancers"],
  ["/freelancers/payments", "finance_freelancers"],
  ["/freelancers/receipts", "finance_freelancers"],
  ["/freelancers", "finance_freelancers"],
  ["/finance/freelancers", "finance_freelancers"],


  ["/finance/ledgers", "finance_ledgers"],
