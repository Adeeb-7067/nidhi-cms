...
export function getNavSections(role: UserRole): NavSection[] {
  const all: NavSection[] = [
    ...
    // =========================
    {
      ...
      items: [
        { title: "Dashboard", href: "/admin", icon: LayoutDashboard, roles: [...INTERNAL_STAFF_ROLES], group: "Overview" },
        { title: "Analytics", href: "/admin/analytics", icon: BarChart3, roles: [...INTERNAL_STAFF_ROLES], group: "Overview" },
        { title: "Companies", href: "/admin/clients", icon: Building2, roles: [...INTERNAL_STAFF_ROLES], group: "Organization" },
        { title: "Projects", href: "/admin/projects", icon: Briefcase, roles: [...INTERNAL_STAFF_ROLES], group: "Organization" },
        { title: "Team", href: "/admin/employees", icon: Users, roles: [...INTERNAL_STAFF_ROLES], group: "Organization" },
        { title: "Roles & permissions", href: "/admin/roles", icon: Shield, roles: [...INTERNAL_STAFF_ROLES], group: "Organization" },
        {
          title: "Requests",
          href: "/admin/requests",
          icon: Inbox,
    ...
    // =========================
    {
      ...
      items: [
        ...
        { title: "Sales team", href: "/sales/team", icon: UserPlus, roles: [...INTERNAL_STAFF_ROLES], group: "Team" },
        { title: "Automation", href: "/sales/settings", icon: Settings, roles: [...INTERNAL_STAFF_ROLES], group: "Team" },
      ],
    },
    ...
    // =========================
    {
      ...
      roles: [...INTERNAL_STAFF_ROLES],
      items: [
        { title: "Dashboard", href: "/legal", icon: LayoutDashboard, roles: [...INTERNAL_STAFF_ROLES], group: "Overview" },
        { title: "Employee cases", href: "/legal/cases", icon: Briefcase, roles: [...INTERNAL_STAFF_ROLES], group: "Matters" },
        { title: "Vendor disputes", href: "/legal/vendor-disputes", icon: Handshake, roles: [...INTERNAL_STAFF_ROLES], group: "Matters" },
        { title: "Client matters", href: "/legal/client-matters", icon: Building2, roles: [...INTERNAL_STAFF_ROLES], group: "Matters" },
        { title: "NDA repository", href: "/legal/nda", icon: FileWarning, roles: [...INTERNAL_STAFF_ROLES], group: "Documents" },
        { title: "Agreements", href: "/legal/agreements", icon: FileText, roles: [...INTERNAL_STAFF_ROLES], group: "Documents" },
        { title: "Legal notices", href: "/legal/notices", icon: Mail, roles: [...INTERNAL_STAFF_ROLES], group: "Documents" },
        { title: "Court cases", href: "/legal/court-cases", icon: Gavel, roles: [...INTERNAL_STAFF_ROLES], group: "Litigation" },
        { title: "Compliance", href: "/legal/compliance", icon: ShieldCheck, roles: [...INTERNAL_STAFF_ROLES], group: "Governance" },
        { title: "Expenses", href: "/legal/expenses", icon: Wallet, roles: [...INTERNAL_STAFF_ROLES], group: "Governance" },
      ],
    },
    ...
    // =========================
    {
      ...
      roles: [...INTERNAL_STAFF_ROLES],
      items: [
        { title: "Dashboard", href: "/finance", icon: LayoutDashboard, roles: [...INTERNAL_STAFF_ROLES], group: "Overview" },
        { title: "Expenses", href: "/finance/expenses", icon: TrendingDown, roles: [...INTERNAL_STAFF_ROLES], group: "Transactions" },
        { title: "Income", href: "/finance/income", icon: TrendingUp, roles: [...INTERNAL_STAFF_ROLES], group: "Transactions" },
        { title: "Payments", href: "/finance/payments", icon: Wallet, roles: [...INTERNAL_STAFF_ROLES], group: "Transactions" },
        { title: "Invoices", href: "/finance/invoices", icon: Receipt, roles: [...INTERNAL_STAFF_ROLES], group: "Billing" },
        { title: "Payroll", href: "/finance/payroll", icon: Users, roles: [...INTERNAL_STAFF_ROLES], group: "Billing" },
        { title: "Budgets", href: "/finance/budgets", icon: PiggyBank, roles: [...INTERNAL_STAFF_ROLES], group: "Planning" },
        { title: "Ledgers", href: "/finance/ledgers", icon: BookOpen, roles: [...INTERNAL_STAFF_ROLES], group: "Planning" },
        { title: "Tax", href: "/finance/tax", icon: Percent, roles: [...INTERNAL_STAFF_ROLES], group: "Planning" },
        { title: "Reports (P&L)", href: "/finance/reports/pnl", icon: BarChart3, roles: [...INTERNAL_STAFF_ROLES], group: "Reports" },
      ],
    },
    ...
    // =========================
    {
      ...
      railLabel: "Collab",
      icon: MessageSquare,
      roles: ["super_admin", "hr", ...DEV_PORTAL_STAFF_ROLES, "client"],
      items: [
        {
          title: "Discussions",
          href: "/discussions",
    ...
    // =========================
    {
      ...
      railLabel: "HRM",
      icon: IdCard,
      roles: ["super_admin", "hr", ...DEV_PORTAL_STAFF_ROLES],
      items: [
        { title: "Dashboard", href: "/hrm", icon: LayoutDashboard, roles: ["super_admin", "hr", "manager", ...DEV_PORTAL_STAFF_ROLES], group: "Overview" },
        ...
        { title: "Recruitment", href: "/hrm/recruitment", icon: UserPlus, roles: [...HRM_ADMIN_ROLES], group: "Extended" },
        ...
        { title: "My attendance", href: "/hrm/my-attendance", icon: ClipboardList, roles: [...MONITORABLE_STAFF_ROLES], group: "Self-service" },
        { title: "My leave", href: "/hrm/my-leave", icon: CalendarDays, roles: [...MONITORABLE_STAFF_ROLES], group: "Self-service" },
        { title: "My WFH", href: "/hrm/my-wfh", icon: Briefcase, roles: [...MONITORABLE_STAFF_ROLES], group: "Self-service" },
        { title: "My payslips", href: "/hrm/my-payslips", icon: Receipt, roles: [...MONITORABLE_STAFF_ROLES], group: "Self-service" },
        { title: "Calendar", href: "/hrm/my-holidays", icon: CalendarClock, roles: [...MONITORABLE_STAFF_ROLES], group: "Self-service" },
      ],
    },
