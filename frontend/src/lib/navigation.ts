...
export function getNavSections(role: UserRole): NavSection[] {
  const all: NavSection[] = [
    ...
    // =========================
    {
      ...
      items: [
        { title: "Dashboard", href: "/sales", icon: LayoutDashboard, roles: [...SALES_STAFF_ROLES], group: "Overview" },
        { title: "Lead management", href: "/sales/leads", icon: Target, roles: [...SALES_STAFF_ROLES], group: "Pipeline" },
        { title: "Follow-ups", href: "/sales/follow-ups", icon: CalendarClock, roles: [...SALES_STAFF_ROLES], group: "Pipeline" },
        { title: "Proposals", href: "/sales/proposals", icon: FileSpreadsheet, roles: [...SALES_STAFF_ROLES], group: "Pipeline" },
        { title: "Customers", href: "/sales/customers", icon: Handshake, roles: [...SALES_STAFF_ROLES], group: "Pipeline" },
        { title: "Installments", href: "/sales/installments", icon: Layers, roles: [...SALES_STAFF_ROLES], group: "Billing" },
        { title: "Invoices", href: "/sales/invoices", icon: Receipt, roles: [...SALES_STAFF_ROLES], group: "Billing" },
        { title: "Payments", href: "/sales/payments", icon: Wallet, roles: [...SALES_STAFF_ROLES], group: "Billing" },
        { title: "Products", href: "/sales/products", icon: Package, roles: [...SALES_STAFF_ROLES], group: "Catalog" },
        { title: "Sales reports", href: "/sales/reports", icon: BarChart3, roles: [...SALES_STAFF_ROLES], group: "Insights" },
        { title: "Financial alerts", href: "/sales/notifications", icon: Bell, roles: [...SALES_STAFF_ROLES], group: "Insights" },
