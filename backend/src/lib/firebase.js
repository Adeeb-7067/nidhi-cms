...
function initFirebaseAdmin() {
  try {
    ...
    if (projectId && clientEmail && privateKey) {
      ...
      logger.warn(
        "Firebase Admin credentials not found (FIREBASE_PROJECT_ID, FIREBASE_CLIENT_EMAIL, FIREBASE_PRIVATE_KEY). FCM push is disabled; Socket.IO notifications still work."
      );
    }
  } catch (error) {
