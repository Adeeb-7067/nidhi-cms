...
export const LoginResponse = zod.object({
  ...
  "name": zod.string(),
  "email": zod.string(),
  "role": zod.enum(['super_admin', 'hr', 'manager', 'developer', 'tester', 'qa', 'client', 'freelancer', 'bde', 'finance', 'digital', 'ca']),
...
export const ListUsersQueryParams = zod.object({
  ...
  "search": zod.string().optional(),
  "staff": zod.string().optional().describe('When \"true\" or \"1\", restrict to internal staff roles only.'),
  "page": zod.number().optional(),
  "limit": zod.number().optional()
})
...
export const UpdateUserBody = zod.object({
  ...
  "role": zod.enum(['super_admin', 'hr', 'manager', 'developer', 'tester', 'qa', 'client', 'freelancer', 'bde', 'finance', 'digital', 'ca']).optional(),
  "subType": zod.string().optional(),
  "designation": zod.string().optional(),
  "avatarUrl": zod.string().optional(),
  "department": zod.string().optional(),
...
export const ListCompanyProjectsResponse = zod.object({
  ...
  "type": zod.enum(['development', 'maintenance', 'digital']),
...
export const ListProjectsQueryParams = zod.object({
  ...
  "companyId": zod.number().optional(),
  "search": zod.string().optional(),
  "type": zod.enum(['development', 'maintenance', 'digital']).optional(),
...
export const CreateProjectBody = zod.object({
  ...
  "digitalServices": zod.object({
  "seo": zod.boolean().optional().describe('Managing SEO campaigns'),
  "metaAds": zod.boolean().optional().describe('Running Meta (Facebook & Instagram) ads'),
  "googleAds": zod.boolean().optional().describe('Running Google Ads')
}).optional(),
  "socialLinks": zod.object({
  "facebook": zod.string().optional(),
  "instagram": zod.string().optional(),
  "linkedin": zod.string().optional(),
  "twitter": zod.string().optional().describe('X / Twitter profile URL'),
...
export const UpdateProjectBody = zod.object({
  ...
  "techStack": zod.array(zod.string()).optional(),
  "digitalServices": zod.object({
  "seo": zod.boolean().optional(),
  "metaAds": zod.boolean().optional(),
  "googleAds": zod.boolean().optional()
}).optional(),
  "socialLinks": zod.object({
  "facebook": zod.string().optional(),
  "instagram": zod.string().optional(),
...
export const GetProjectBugsResponse = zod.object({
  ...
  "reporterRole": zod.string().nullish(),
  "assigneeId": zod.number().nullish(),
  "assigneeName": zod.string().nullish(),
  "assigneeRole": zod.string().nullish(),
  ...
  "issues": zod.array(zod.unknown()).optional(),
  ...
  "latestComment": zod.string().nullish(),
