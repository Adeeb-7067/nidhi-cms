...
// GET /api/logs ΓÇö own logs for dev/QA; all team logs for super admin
...
// POST /api/logs ΓÇö developers and testers only
export async function postLogs(req: Request, res: Response) {
  ...
  // ΓöÇΓöÇ Notify PM or Admins about the log ΓöÇΓöÇ
  try {
...
// PATCH /api/logs/:id
export async function patchLogsById(req: Request, res: Response) {
