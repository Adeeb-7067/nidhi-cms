...
export async function getAnalyticsProjectsById(req: Request, res: Response) {
...
export async function getAnalyticsTeam(req: Request, res: Response) {
  const now = new Date();
...
export async function getAnalyticsBugs(req: Request, res: Response) {
...
export async function getAnalyticsCompanies(req: Request, res: Response) {
