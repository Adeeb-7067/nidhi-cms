...
import { formatRequestRow, formatRequestRows } from "@/services/request-format";
...
// GET /api/requests/:id
export async function getRequestsById(req: Request, res: Response) {
...
export async function patchRequestsById(req: Request, res: Response) {
  const id = parseIdParam(req.params.id, "request id");
