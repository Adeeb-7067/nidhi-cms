...
router.post("/projects", requireAuth, requireRole("super_admin", "bde"), asyncHandler(projectsController.postProjects));
router.get("/projects/:id", requireAuth, asyncHandler(projectsController.getProjectsById));
router.patch("/projects/:id", requireAuth, requireRole("super_admin", "bde"), asyncHandler(projectsController.patchProjectsById));
router.delete("/projects/:id", requireAuth, requireRole("super_admin", "bde"), asyncHandler(projectsController.deleteProjectsById));
