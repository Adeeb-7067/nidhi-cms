...
import * as mediaCtrl from "../controllers/marketing/media.controller.js";
import * as workflowCtrl from "../controllers/marketing/workflow.controller.js";
import * as queuesCtrl from "../controllers/marketing/queues.controller.js";
import * as insightsCtrl from "../controllers/marketing/insights.controller.js";
...
router.delete("/marketing/posts/:id", ...p("marketing_calendar", "delete"), wrap(workflowCtrl.deletePost));
