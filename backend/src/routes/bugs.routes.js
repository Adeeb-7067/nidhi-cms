...
router.post("/bugs/batch", requireAuth, requireRole("developer", "tester", "qa", "super_admin"), asyncHandler(bugsController.postBugsBatch));
router.post("/bugs", requireAuth, requireRole("developer", "tester", "qa", "super_admin"), asyncHandler(bugsController.postBugs));
