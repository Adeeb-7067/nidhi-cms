...
import * as expensesCtrl from "./controllers/expenses.controller.js";
import * as incomeCtrl from "./controllers/income.controller.js";
...
import * as budgetsCtrl from "./controllers/budgets.controller.js";
import * as loansCtrl from "./controllers/loans.controller.js";
import * as subscriptionsCtrl from "./controllers/subscriptions.controller.js";
import * as chequesCtrl from "./controllers/cheques.controller.js";
import * as ledgersCtrl from "./controllers/ledgers.controller.js";
import * as taxCtrl from "./controllers/tax.controller.js";
import * as reportsCtrl from "./controllers/reports.controller.js";
import * as vendorsCtrl from "./controllers/vendors.controller.js";
import * as vendorInvoicesCtrl from "./controllers/vendor-invoices.controller.js";
import * as notificationsCtrl from "./controllers/notifications.controller.js";
import * as syncCtrl from "./controllers/sync.controller.js";
import * as freelancerEngagementsCtrl from "./controllers/freelancer-engagements.controller.js";
...
router.post(
  "/finance/vendor-invoices/:id/payments",
  ...anyP(["finance_vendors", "edit"], ["finance_payments", "create"]),
  wrap(vendorInvoicesCtrl.payVendorInvoice),
);
router.delete(
  "/finance/vendor-invoices/:id",
...
router.get(
  "/finance/freelancer-engagements/:id/installments/:installmentId/receipt",
  ...p("finance_freelancers"),
  wrap(freelancerEngagementsCtrl.getInstallmentReceipt),
);
router.delete(
  "/finance/freelancer-engagements/:id/installments/:installmentId",
  ...p("finance_freelancers", "delete"),
