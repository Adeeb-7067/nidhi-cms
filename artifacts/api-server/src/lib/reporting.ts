...
import { storeGeneratedFile } from "./file-storage";
...
export async function generatePdfReport(reportId: number, type: string, params: any): Promise<string> {
...
export async function generateExcelReport(reportId: number, type: string, params: any): Promise<string> {
